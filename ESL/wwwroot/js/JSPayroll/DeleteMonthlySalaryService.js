...
function getSalaryDate() {
    var url = "/Payroll/DeleteMonthlySalary/getSalaryDate";
...
function getDepartment(pSalaryDate) {
    var url = "/Payroll/DeleteMonthlySalary/getDepartment?pSalaryDate=" + pSalaryDate;
...
function getSection(pSalaryDate,pDepartmentId) {
    var url = "/Payroll/DeleteMonthlySalary/getSection?pSalaryDate=" + pSalaryDate + "&pDepartmentId=" + pDepartmentId;
...
function getEmployee(pSalaryDate, pDepartmentId, pSectionId) {
    var url = "/Payroll/DeleteMonthlySalary/getEmployee?pSalaryDate=" + pSalaryDate + "&pDepartmentId=" + pDepartmentId + "&pSectionId=" + pSectionId;
